...
func TestTransformWithFloydSteinbergPNGPar(t *testing.T) {
	...
	if !tr.transformParallel("schwarz_weiss.png", "FloydSteinberg", 1) {
...
func TestAnalyzePictureSchwellwertJPGPar(t *testing.T) {
	if !analyzePicturePar("schwarz_weiss.jpg", "Schwellwert", 1) {
...
func TestAnalyzePictureFloydSteinbergPNGPar(t *testing.T) {
	if !analyzePicturePar("schwarz_weiss.png", "FloydSteinberg", 1) {
...
func TestAnalyzePictureFloydSteinbergJPGPar(t *testing.T) {
	if !analyzePicturePar("schwarz_weiss.jpg", "FloydSteinberg", 1) {
...
func TestAnalyzePictureAlgorithm2PNGPar(t *testing.T) {
	if !analyzePicturePar("schwarz_weiss.png", "Algorithm2", 1) {
...
func TestAnalyzePictureAlgorithm2JPGPar(t *testing.T) {
	if !analyzePicturePar("schwarz_weiss.jpg", "Algorithm2", 1) {
...
func TestAnalyzePictureAlgorithm3PNGPar(t *testing.T) {
	if !analyzePicturePar("schwarz_weiss.png", "Algorithm3", 1) {
...
func TestAnalyzePictureAlgorithm3JPGPar(t *testing.T) {
	if !analyzePicturePar("schwarz_weiss.jpg", "Algorithm3", 1) {
...
func TestAnalyzePictureGraustufenPNGPar(t *testing.T) {
	if !analyzePicturePar("schwarz_weiss.png", "Graustufen", 1) {
...
func TestAnalyzePictureGraustufenJPGPar(t *testing.T) {
	if !analyzePicturePar("schwarz_weiss.jpg", "Graustufen", 1) {
